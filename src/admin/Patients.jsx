          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {patients.map((patient) => (
              ...
              >
                ...
                <p><Mail size={14} /> {patient.user?.email}</p>
                ...
                <div className="flex gap-2 mt-3">
                  <button onClick={() => toggleStatus(patient.user._id)}>
                    {patient.user?.isActive ? <ShieldOff /> : <ShieldCheck />}
                  </button>

                  {!patient.user?.isActive && (
                    <button onClick={() => deletePatient(patient.user._id)}>
                      🗑
                    </button>
                  )}
                </div>
